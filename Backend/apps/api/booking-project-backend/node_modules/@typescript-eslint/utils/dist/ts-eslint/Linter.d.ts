import type { ClassicConfig, FlatConfig, SharedConfig } from '@typescript-eslint/utils/dist/ts-eslint/Config';
import type { Parser } from '@typescript-eslint/utils/dist/ts-eslint/Parser';
import type { Processor as ProcessorType } from '@typescript-eslint/utils/dist/ts-eslint/Processor';
import type { AnyRuleCreateFunction, AnyRuleModule, RuleCreateFunction, RuleFix, RuleModule } from '@typescript-eslint/utils/dist/ts-eslint/Rule';
