...
import type { CompatibleConfig, CompatibleConfigArray, CompatibleParser, CompatiblePlugin } from 'typescript-eslint/dist/compatibility-types';
import { config } from 'typescript-eslint/dist/config-helper';
...
export { config, type ConfigWithExtends, type InfiniteDepthConfigWithExtends, type ConfigArray, } from 'typescript-eslint/dist/config-helper';
